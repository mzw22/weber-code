...
# Import data
input_data <- read.csv("../../data/kloepper2010/kloepper2010_Fig2_data.csv")

# Standardise data
data <- input_data %>%
  mutate(a = 6.35, #standard
         b = a + difference,
...
write.csv(data, "../../results/standard_data/kloepper2010_standard.csv",
          row.names=FALSE)
...
export_model_results(di=data$abs_diff, i=data$mean_ab, k_estimate=k_estimate,
                     ...
                     stimulus="wall thickness",
                     ref="Kloepper et al. 2010",
                     file_prefix="kloepper2010",
                     n_pairs=n_pairs)
