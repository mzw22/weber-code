...
# Import raw data
input_data <- read.csv("../../data/lemus2009/lemus2009_Fig1B_data.csv")

# Standardise data
data <- input_data %>%
  mutate(a = f1, b = f2,
         response=discrimination_percent/100,
         N = n_trials) %>%  
...
write.csv(data, "../../results/standard_data/lemus2009_standard.csv")
