...
# Import data
input_data <- read.csv("../../data/nachev2013/WL_cumulative_data_BatsCR.csv")
...
write.csv(data, "../../results/standard_data/nachev2013_batscr_standard.csv",
          row.names=FALSE)
...
export_model_results(di=data$abs_diff, i=data$mean_ab, k_estimate=k_estimate,
                     ...
                     stimulus="sugar conc.",
                     ref="Nachev and Winter 2012",
                     file_prefix="nachev2013_batscr",
                     n_pairs=n_pairs)
