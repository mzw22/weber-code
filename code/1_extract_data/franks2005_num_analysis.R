...
export_model_results(di=data$abs_diff, i=data$mean_ab, k_estimate=k_estimate,
                     response=data$response, weights=data$N,
                     family=binomial(link="logit"),
                     response_lab="Proportion of colonies choosing lower number",
                     stimulus="Entrance number",
                     ref="Franks et al. 2005",
                     file_prefix="franks2005_num",
                     n_pairs=n_pairs)
