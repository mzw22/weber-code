...
# Import data
input_data <- read.csv("../../data/romo2004/romo2004_fig1.csv")

# Standardise data
data <- input_data %>%
  mutate(a = f1, #round graphgrabber numbers
         b = f2,
         response = percent_correct/100,
         N = 10*434/7) %>% #10 trials*434 neurons/7 electrodes
...
write.csv(data, "../../results/standard_data/romo2004_standard.csv",
          row.names=FALSE)
