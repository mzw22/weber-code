...
# Standardise data
data <- input_data %>%
  mutate(a = as.numeric(calls["Pulse Period", treatment_col]),
         b = as.numeric(calls["Pulse Period", "X0_Control"]),
...
write.csv(data, "../../results/standard_data/tumulty2022_period_standard.csv",
          row.names=FALSE)
