...
# Import data
input_data <- read.csv("../../data/agrillo2012/agrillo2012_fig4.csv")
...
write.csv(data, "../../results/standard_data/agrillo2012_standard.csv",
          row.names=FALSE)
...
export_model_results(di=data$abs_diff, i=data$mean_ab, k_estimate=k_estimate,
                     ...
                     ref="Agrillo et al. 2012",
                     file_prefix="agrillo2012",
                     n_pairs=n_pairs)
