...
# Import data
input_data <- read.csv("../../data/bee2012/Bee_et_al_2012_JASA_DATA.csv")

data <- input_data %>%
  mutate(a = Attenuated_Signal_Level,
         b = Unattenuated_Signal_Level,
...
write.csv(data, "../../results/standard_data/bee2012_standard.csv",
          row.names=FALSE)
