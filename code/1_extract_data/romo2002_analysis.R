...
# Import data
input_data <- read.csv("../../data/romo2002/romo2002_fig1.csv")
...
data <- input_data %>%
  mutate(a = round(f1),
         ...
         N = 10) %>% #10 trials per stimulus pair
...
write.csv(data, "../../results/standard_data/romo2002_standard.csv",
          row.names=FALSE)
